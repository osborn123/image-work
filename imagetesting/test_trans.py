...
def main(args):
    ...
    wandb.init(project="feature-transform", config=args, mode="disabled")  # Initialize wandb with mode="disabled"
    ...
    for overlap_rate in overlap_rates:
        ...
        recall_results, mean_recall, max_recall, mean_square_recall = test_recall(feature1, feature2, feature2_selected, only_1_index, only_2_index, search_range)
