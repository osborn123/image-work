...
def main(args):
    ...
    # recall_list = test_reall(args, feature1, feature2, feature1_transformed, only_1_index, only_2_index, start_time)
    ...
    pprint(sp_ans)
    # sp_ans = test_sp(args, feature1, feature2, feature1_transformed, only_1_index, only_2_index, overlap_index, start_time, dist, normalization="unnorma")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--with_activation", type=int, default=1, help="device for training")
